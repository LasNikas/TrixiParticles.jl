...
trixi_include(@__MODULE__,
              joinpath(examples_dir(), "preprocessing", "liquify_julia_logo_3d.jl"),
...
fluid_system = EntropicallyDampedSPHSystem(initial_conditions[end], smoothing_kernel,
...
saving_callback = SolutionSavingCallback(dt=0.02, prefix="",
                                         output_directory="out_julia_logo_3d_dp_$particle_spacing")
