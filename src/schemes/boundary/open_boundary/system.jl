...
function OpenBoundarySPHSystem(boundary_model, initial_condition, fluid_system,
                               ...
                               pressure_acceleration_formulation, shifting_technique,
                               acceleration, cache)
...
function OpenBoundarySPHSystem(boundary_zones::Union{BoundaryZone, Nothing}...;
    ...
    return OpenBoundarySPHSystem(boundary_model, initial_conditions, fluid_system,
                                 ...
                                 mass, volume, boundary_candidates, fluid_candidates,
                                 boundary_zone_indices, boundary_zones_new, buffer,
                                 fluid_system.pressure_acceleration_formulation,
                                 shifting_technique_, fluid_system.acceleration, cache)
end
...
# TODO
# @inline function current_velocity(v, system::OpenBoundarySPHSystem)
